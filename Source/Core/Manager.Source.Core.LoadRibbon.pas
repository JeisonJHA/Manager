unit Manager.Source.Core.LoadRibbon;

interface

uses Classes, SysUtils, Forms, InstantPresentation, InstantPersistence,
  BarraFerramenta, Acao, dxRibbon, dxBar, Manager.Source.Core.ActionWorkspace,
  Manager.Source.Core.LoadMenu;
...
uses Manager.Source.Core.AplicationHelper,
  ...
  Manager.Source.Forms.DataModule.Resources, Manager.Source.Forms.Main;
