...
#define MyAppName "Manager Developer"
#define MyAppFolder "Developer"
#define MyAppVersion "2.0"
#define MySoftHouseName "Manager"
#define MyAppPublisher "Manager"
#define MyAppURL "http://manager.plussoftware.com.br"
...
AppId={{20C50DB4-A4E2-4EDF-8B82-7662A5C3001A}
AppName={#MyAppName}
...
DefaultDirName={pf}\{#MySoftHouseName}\{#MyAppFolder}\{#MyAppVersion}
...
[Files]
Source: ..\Build\Bin\Win32\Release\ManagerDev.exe; DestDir: {app}; Permissions: everyone-modify; DestName: manager.exe
Source: ..\Build\Bin\Win32\Release\ManagerUpdate.exe; DestDir: {app}; Permissions: everyone-modify; DestName: updater.exe
...
Source: Recursos\data.fdb; DestDir: {commonappdata}\{#MySoftHouseName}\{#MyAppFolder}\{#MyAppVersion}\Data; Permissions: everyone-modify; Flags: uninsneveruninstall onlyifdoesntexist
...
; ### Scripts ###
Source: recursos\Scripts\1.1.0.5\*.sql; DestDir: {app}\Scripts
...
[Registry]
Root: HKCU; Subkey: SOFTWARE\{#MySoftHouseName}\{#MyAppFolder}\{#MyAppVersion}\Database\; ValueType: string; ValueName: DatabaseName; ValueData: {commonappdata}\{#MySoftHouseName}\{#MyAppFolder}\{#MyAppVersion}\Data\{#MyAppDatabaseName}; Flags: createvalueifdoesntexist uninsdeletekey
Root: HKCU; Subkey: SOFTWARE\{#MySoftHouseName}\{#MyAppFolder}\{#MyAppVersion}\SCM\; ValueType: string; ValueName: Workspace; Flags: createvalueifdoesntexist uninsdeletekey; ValueData: c:\
Root: HKCU; Subkey: SOFTWARE\{#MySoftHouseName}\{#MyAppFolder}\{#MyAppVersion}\; ValueType: string; ValueName: Caminho; ValueData: {app}; Flags: createvalueifdoesntexist uninsdeletekey
Root: HKCU; Subkey: SOFTWARE\{#MySoftHouseName}\{#MyAppFolder}\{#MyAppVersion}\Sandbox\; ValueType: string; ValueName: ArquivosIni; Flags: createvalueifdoesntexist uninsdeletekey
Root: HKCU; Subkey: SOFTWARE\{#MySoftHouseName}\{#MyAppFolder}\{#MyAppVersion}\Utils\; ValueType: dword; ValueName: PrimeiraExecucao; Flags: createvalueifdoesntexist uninsdeletekey; ValueData: 1
Root: HKCU; Subkey: SOFTWARE\{#MySoftHouseName}\{#MyAppFolder}\{#MyAppVersion}\Utils\; ValueType: string; ValueName: spSQL; Flags: createvalueifdoesntexist uninsdeletekey
