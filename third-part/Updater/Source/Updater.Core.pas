...
procedure TUpdaterCore.ReadInfoUpdater;
var
  LFile : string;
  Node   : OleVariant;
  XmlDoc : OleVariant;
...
procedure TUpdaterCore.ReadLocalInfo;
begin
...
procedure TUpdaterCore.ReadRemoteInfo;
var
  XmlDoc: OleVariant;
  Node: OleVariant;
begin
...
function TUpdaterCore.GetUpdateAvailable: boolean;
begin
  Result := False;
  try
    ReadInfoUpdater();
